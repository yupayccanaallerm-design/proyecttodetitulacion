# MunayPalta Voice - Chatbot

Asistente conversacional en español con voz, RAG (usa tus PDFs con citas) y memoria basica.
Corre local en tu PC (8 GB). Frontend servido por FastAPI.
...
## 5) Probar
- Manten presionado el microfono y di "hola" -> responde en voz y texto.
- Pregunta: "sintomas de antracnosis" -> si indexaste PDFs, veras citas.
- "recuerda que prefiero respuestas cortas" -> guarda en memoria.
