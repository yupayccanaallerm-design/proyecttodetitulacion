...
export default function AdminDashboard() {
  ...
  const nombreUsuario = localStorage.getItem('admin_name') || t('admin_usuario_activo');
  const rolUsuario = localStorage.getItem('user_role') || t('admin_operador');
  ...
  const handleLogout = () => {
    if (window.confirm(t("admin_logout_confirm"))) {
      localStorage.clear();
      navigate("/login");
    }
  };
        ...
        <div className="space-y-8">
          <div className="flex items-center gap-3 px-2 py-1 border-b border-slate-900 pb-5">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-slate-500 font-medium tracking-wider uppercase">{t("admin_panel")}</span>
            </div>
          </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="hidden lg:flex flex-col text-left">
                ...
                <span className="text-[10px] text-slate-400 font-medium mt-0.5 capitalize">
                  {rolUsuario === 'admin' ? t("admin_administrador") : rolUsuario}
                </span>
              </div>
            </div>
          </div>
